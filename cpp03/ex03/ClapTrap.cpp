...
ClapTrap::ClapTrap() : _name("Noname"), _hitp(10), _energyp(10), _attackd(0){
    std::cout << "ClapTrap : Default construtor has been called." << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hitp(10), _energyp(10), _attackd(0){
    std::cout << "ClapTrap : Parameterized construtor has been called." << std::endl;
}
...
ClapTrap& ClapTrap::operator=(const ClapTrap& other){
    std::cout << "ClapTrap : Copy assignment operator overload has been called." << std::endl;
